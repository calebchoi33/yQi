...
from ..frontend.evaluation.core.config import EvaluationConfig
from ..frontend.evaluation.core.evaluator import Evaluator
from ..frontend.evaluation.core.prompts import PromptManager
...
def main():
    ...
    try:
        ...
        sys.path.append(str(Path(__file__).parent.parent.parent / 'frontend' / 'evaluation'))
