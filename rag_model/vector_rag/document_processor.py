...
from chunking_strategies_semantic import ChunkingStrategyFactory, TCMMarkerDetector
...
class DocumentProcessor:
    ...
    def __init__(self, docs_directory: Optional[str] = None):
        ...
        if docs_directory is None:
            ...
            rag_model_root = models_dir.parent
            self.docs_directory = rag_model_root / "data" / "documents"
        else:
